...
type SectionId = "venue" | "staff" | "courts" | "devices" | "hours" | "pricing" | "products" | "schedule" | "links" | "stories" | "events" | "eventLeads" | "eventProducts" | "resourceBlocks" | "operations" | "memberships" | "templates" | "corporate" | "channels" | null;
...
const AdminPage = () => {
    ...
    return (
      <div className="min-h-screen bg-background max-w-2xl mx-auto">
        ...
        <div className="px-4 pb-8 pt-1">
          ...
          {activeSection === "operations" && <AdminVenueOperations venueId={venueId} />}
  ...
  const actionCards = [
    ...
    { id: "operations" as SectionId, icon: ShieldAlert, label: "Drift", stat: "Avvikelser & stängt", color: "var(--primary)" },
