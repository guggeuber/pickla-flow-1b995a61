...
- Zettle historical backfill: missing historical POS revenue can be reconciled with [docs/financial-operations/zettle-historical-backfill.md](./docs/financial-operations/zettle-historical-backfill.md).
